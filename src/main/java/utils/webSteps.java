...
public class webSteps {
    ...
    public String getValue(String locator) {
        By xpath = constructElement(findElementRepo(locator));
        return driver.findElement(xpath).getDomAttribute("value");
    }
...
//        }
    ...
    public static String generateRandomCustomerContactNo() {
        int contactNumber = ThreadLocalRandom.current().nextInt(100_000_000, 1_000_000_000);
        String contact = String.valueOf(contactNumber);
        return contact;
    }
    ...
    public String generateRandomCityName() {
        String randomCityName = "City_" + ThreadLocalRandom.current().nextInt(0, 100);
        return randomCityName;
    }

    public static String generateRandomCityPostalCode() {
        int postalCode = ThreadLocalRandom.current().nextInt(10000, 99999);
    ...
    public String generateRandomProductSellingPrice() {
        String[] values = {"10000", "5500", "2750", "12750", "1500", "3250", "6700", "8550"};
        Random random = new Random();
    ...
    public String generateRandomSourceName() {
        String randomLocationCity = "Source_" + ThreadLocalRandom.current().nextInt(0, 100);
        return randomLocationCity;
    }
